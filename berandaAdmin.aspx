<%@ Page Language="vb" AutoEventWireup="false"  MasterPageFile="~/MainAdmin.Master" CodeBehind="berandaAdmin.aspx.vb" Inherits="Kel3_BudayaRiau_3SIA.berandaAdmin" %>
            ...
            <div class="row">
                ...
                <div class="col-xl-8 col-lg-7">
                    <div class="card shadow mb-4">
                        ...
                        <div
                            ...
                            <h6 class="m-0 font-weight-bold text-primary">Data Usia Pengguna</h6>
                        ...
                        <div class="card-body">
                            <div class="chart-area">
                                <asp:Chart ID="Chart1" runat="server" DataSourceID="SqlDataSource1">
                                    <Series>
                                        <asp:Series Name="Series1" XValueMember="nama" YValueMembers="umur" YValuesPerPoint="2"></asp:Series>
                                    </Series>
                                    <ChartAreas>
                ...
                <div class="col-xl-4 col-lg-5">
                    <div class="card shadow mb-4">
                        ...
                        <div
                            class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                            <h6 class="m-0 font-weight-bold text-primary">Data pengguna terakhir kali mendaftar</h6>
                            <div class="dropdown no-arrow">
                                <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <i class="fas fa-ellipsis-v fa-sm fa-fw text-gray-400"></i>
                        ...
                        <div class="card-body">
                            <div class="chart-pie pt-4 pb-2">
                                <center>
                                    <asp:ListView ID="ListView1" runat="server" DataKeyNames="id" DataSourceID="SqlDataSource2" DataMember="DefaultView">
                                        <AlternatingItemTemplate>
                                            <td runat="server" style="background-color: #FFFFFF; color: #284775;">

                                                <asp:Image Style="width: 117px;" ID="Image" runat="server" ImageUrl='<%# Eval("ID", "HandlerDataPengguna.ashx?ID={0}")%>' />
                                                <br />
                                        ...
                                        <EditItemTemplate>
                                            <td runat="server" style="background-color: #999999;">
                                                ...
                                                <asp:Image Style="width: 117px;" ID="Image" runat="server" ImageUrl='<%# Eval("ID", "HandlerDataPengguna.ashx?ID={0}")%>' />
                                                <br />
                                                <asp:TextBox ID="namaTextBox" runat="server" Text='<%# Bind("nama") %>' />
                                                <br />
                                ...
                                <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:BudayaRiauConnectionString %>" SelectCommand="Select id, Image,nama from pengguna ORDER BY ID DESC"></asp:SqlDataSource>
                            </div>
                            <div class="mt-4 text-center small">
                                <span class="mr-2">
                                    <i class="fas fa-circle text-primary"></i>Terbaru
                                </span>
                                <span class="mr-2">
                                    <i class="fas fa-circle text-success"></i>agak terbaru
                                </span>
                                <span class="mr-2">
                                    <i class="fas fa-circle text-info"></i>Lawas
                                </span>
                            </div>
                        </div>
                    </div>
